...
INSERT INTO `GROUP_LEADER` VALUES (1,1,'健身小隊'),(2,2,'減肥小隊');
...
CREATE TABLE `GROUP_MEMBER` (
  ...
  KEY `Members` (`Members`),
  CONSTRAINT `group_member_ibfk_1` FOREIGN KEY (`M_GroupID`) REFERENCES `GROUP_LEADER` (`GroupID`),
...
INSERT INTO `GROUP_MEMBER` VALUES (1,2),(1,3),(2,4);
...
INSERT INTO `MEAL` VALUES (1,1,'2024-12-22','08:00:00','Breakfast'),(2,1,'2024-12-22','12:00:00','Lunch'),(1,2,'2024-12-22','09:00:00','Breakfast'),(2,2,'2024-12-22','13:00:00','Lunch');
...
INSERT INTO `MEAL_FOOD` VALUES (1,1,1,3),(2,2,2,1);
...
-- Dump completed on 2024-12-29 11:50:14
